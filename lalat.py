...
def detect_lalat():
  ...
  detected = run(weights="./Model/Lalat/yolov5_best.pt", source=os.path.join("images", 'image.jpg'), imgsz=(448,448), save_txt=False, save_conf=False, nosave=False, conf_thres=0.4, hide_conf=True, hide_labels=True, line_thickness=3)
